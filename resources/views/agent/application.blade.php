                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a style="color:#3366cc" href="/student-application-review/{{$applicationlist->app_id}}">{{$applicationlist->app_id}}</a>
                                            </td>
                                            <td class="text-center"><a style="color:#3366cc" href="/agent_student_profile/{{ $applicationlist->user_id }}">{{$applicationlist->user_id}}</a></td>
                                            ...
                                            <td class="text-center"><span class="{{$applicationlist->bgcolor}} px-2 py-1 rounded-pill text-white text-white notPaid-main">{{$applicationlist->status_name}}</span></td>
                                            ...
                                            <td class="text-center"><span>{{date('d-M-Y', strtotime($applicationlist->earliest_intake_date))}} </span></td>
