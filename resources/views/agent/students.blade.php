                                        ...
                                        @if (count($student_list) >0)
                                            @foreach ($student_list as $studentlist)
                                                <tr>
                                                    ...
                                                    <td class="text-center studentid_hide"><a style="color:#3366cc" href="/agent-student-profile/{{ $studentlist->id }}">{{ $studentlist->id }}</a></td>
                                                    <td class="text-center studentemail_hide"><a style="color:#3366CC;;" href="/agent-student-profile/{{ $studentlist->id }}">{{ $studentlist->email }}</a></td>
                                                    <td class="text-center fname_hide"><span>{{ $studentlist->name }}</span></td>
                                                    <td class="text-center fname_hide"><span>{{ $studentlist->last_name }}</span></td>
                                                    <td class="text-center lname_name"><span>{{ $studentlist->country_of_citizenship }}</span></td>
                                                    <td class="text-center nationality_hide"><span>{{ $studentlist->recruitment_partner }}</span></td>
