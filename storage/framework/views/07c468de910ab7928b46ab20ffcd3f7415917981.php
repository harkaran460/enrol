                                ...
                                <div class="css-1y75kwg css-1jlq0r60">
                                    ...
                                    <div class="css-1ca1ag7 css-1jlq0r61 profile-top-main">
                                        <div class="css-1yyj7dd css-1jlq0r63">
                                            <?php echo e(ucfirst(trans($studentdetails[0]->first_name))); ?>
                                        ...
                                        <div>
                                            ...
                                            <span class="css-1ai5g3s css-1jlq0r64">
                                                <a
                                                    href="mailto:<?php echo e($studentdetails[0]->email); ?>"><?php echo e($studentdetails[0]->email); ?></a>
                                            </span>
                                            <span class="css-1ai5g3s css-1jlq0r64">|</span>
                                            <span class="css-1ai5g3s css-1jlq0r64">
                                                ...
                                                <select name="country_of_citizenship" id="country_of_citizenship"
                                                    ...
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($country->id); ?>"
                                                            <?php echo e($studentdetails[0]->country_of_citizenship == "$country->id" ? 'selected' : ''); ?>>
                                        ...
                                        <div class="bg-white p-3">
                                            ...
                                            <div id="indianSchoolmain">
                                                <div id="indianSchoolmaininner" class="mx-4">
                                                    <?php if($studentdetails[0]->name_of_institution !=''): ?>
                                                    <h2 class="text-start pt-2 fs-3">
                                                        <?php echo e($studentdetails[0]->name_of_institution); ?></h2>
                                                    <?php endif; ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control datepicker_input"
                                                            value="<?php echo e($studentdetails[0]->date_of_exam); ?>"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="exam_type"
                                                            ...
                                                            <?php $__currentLoopData = $getEnglishexamType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value=<?php echo e($type->id); ?> <?php if ($studentdetails[0]->english_exam_type == $type->id) {
                                                                    echo 'selected';
                                                                } else {
                                                                    echo '';
                                                                } ?>>
...
<?php echo $__env->make('layouts.agent_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\design\resources\views/agent/student_profile.blade.php ENDPATH**/ ?>