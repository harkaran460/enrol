                ...
                <div class="col-md-12">
                    <div id="crumbs">
                        <ul>
                            ...
                            <li><a href="#"
                                    class="<?php if($astatus >= 0): ?> application-active <?php else: ?> '' <?php endif; ?> "><i
                                        class="fa-solid fa-check"></i><span> Pay Application Fee</span></a></li>
                            <li><a href="#"
                                    class="<?php if($astatus >= 2): ?> application-active <?php else: ?> '' <?php endif; ?> "><i
                                        class="fa-solid fa-check"></i><span> Prepare Application</span></a></li>
                            <li><a href="#"
                                    class="<?php if($astatus >= 3): ?> application-active <?php else: ?> '' <?php endif; ?> "><i
                                        class="fa-solid fa-check"></i><span> Submission In Progress</span></a></li>
                            <li><a href="#"
                                    class="<?php if($astatus >= 4): ?> application-active <?php else: ?> '' <?php endif; ?> "><i
                                        class="fa-solid fa-check"></i><span> Decision</span></a></li>
                            <li><a href="#"
                                    class="<?php if($astatus >= 5): ?> application-active <?php else: ?> '' <?php endif; ?> "><i
                                        class="fa-solid fa-check"></i><span> Post-Decision Requirements</span></a></li>
                            <li><a href="#"
                                    class="<?php if($astatus >= 12): ?> application-active <?php else: ?> '' <?php endif; ?> "><i
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="ready-submit"
                                            <?php if($astatus >= 7): ?> <?php else: ?> '' <?php endif; ?> disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="submitted-school"
                                            <?php if($astatus >= 8): ?> <?php else: ?> '' <?php endif; ?> disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="ready-visa"
                                            <?php if($astatus >= 9): ?> <?php else: ?> '' <?php endif; ?> disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="ready-enroll"
                                            <?php if($astatus >= 10): ?>  <?php else: ?> '' <?php endif; ?> disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value=""
                                            ...
                                            <?php if($astatus >= 12): ?>  <?php else: ?> '' <?php endif; ?> disabled>
                                            ...
                                            <div class="row">
                                                <div class="accordion-button" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="col-md-4 ps-2">
                                                        ...
                                                        <p class=""><?php echo e($student_details->country_of_citizenship); ?>

                                                        </p>
                                                    </div>
                                                    <div class="col-md-4 ps-2">
                                                        <p class=" opacity-50">Residence</p>
                                                        <p class=""><?php echo e($student_details->country); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </h2>
                    ...
                    <div class="application-custom-box my-3">
                        <div class="main-review-left">
                            ...
                            <div class="row students-all-payments">
                                ...
                                <div class="col-8">
                                    <p class=" text-center opacity-50 "><?php echo e($student_details->payment_status); ?> </p>
                                                                ...
                                                                <div class="right-side-content">
                                                                    ...
                                                                    <div class="stage-card-summary">
                                                                        <div class="css-1lrwgxh">
                                                                            <div class="css-10vh6ur" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Missing <?php echo e($missing_doc); ?>">
                                                                                <img  src="/assetsAgent/img/worning-icon.svg">
                                                                                <!-- <div>0</div> -->
                                                                            </div>
                                                                            <div class="css-1q3p0bj" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Reviewing <?php echo e($upload_doc_review_count); ?>">
                                                                                <img src="/assetsAgent/img/load.svg">
                                                                                <!-- <div>0</div> -->
                                                                            </div>
                                                                            <div class="css-n118i9" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Not Approved <?php echo e($upload_doc_canciled_count); ?>">
                                                                                <img src="/assetsAgent/img/worng-icon.svg">
                                                                                <!-- <div>0</div> -->
                                                                            </div>
                                                                            <div class="css-epjyqf" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Completed <?php echo e($upload_doc_verifiyed_count); ?>">
...
<?php echo $__env->make('layouts.agent_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/design/resources/views/agent/student_application_review.blade.php ENDPATH**/ ?>