...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assetsStudent/css/ion.rangeSlider.min.css')); ?>" />
    <link href="<?php echo e(asset('assetsStudent/css/bootstrap.min.css')); ?>" id="bootstrap-style" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('assetsStudent/css/icons.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('assetsStudent/css/app.min.css')); ?>" id="app-style" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.4.2/chosen.min.css">
    <link href="<?php echo e(asset('assetsStudent/css/select2.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.5.7/jquery.fancybox.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('assetsStudent/css/style.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assetsStudent/css/responsive.css')); ?>">
</head>
...
<body data-sidebar="dark" id="main">
                        ...
                        <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i> -->
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item user-name" href="javascript::">
                                    <span class=" font-size-14"><b> <?php echo e(Auth::check() ? Auth::user()->name : ''); ?></b></span>
                                    <span class=" font-size-12 opacity-50"><?php echo e('Student'); ?></span>
                                </a>
    ...
    <!-- JAVASCRIPT -->
     <!--<script src="<?php echo e(asset('assetsStudent/js/jquery.min.js')); ?>"></script> -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.4.2/chosen.jquery.min.js"></script>
    <script src="<?php echo e(asset('assetsStudent/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assetsStudent/js/metisMenu.min.js')); ?>"></script>
    
    <!-- Editor js -->
    <script src="https://cdn.ckeditor.com/4.13.0/standard/ckeditor.js"></script>

    <script src="<?php echo e(asset('assetsStudent/js/select2.min.js')); ?>"></script>

    <script src="<?php echo e(asset('assetsStudent/js/ecommerce-select2.init.js')); ?>"></script>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.5.7/jquery.fancybox.min.js"></script>

    <script src="<?php echo e(asset('assetsStudent/js/ion.rangeSlider.min.js')); ?>"></script>
    <!-- Range slider init js-->
    <script src="<?php echo e(asset('assetsStudent/js/range-sliders.init.js')); ?>"></script>
    <script src="<?php echo e(asset('assetsStudent/js/chart.js')); ?>"></script>

    <!-- App js -->
    <script src="<?php echo e(asset('assetsStudent/js/app.js')); ?>"></script>
    <script src="<?php echo e(asset('assetsStudent/js/main.js')); ?>"></script>
...
</html><?php /**PATH /home/enrolhere/public_html/college/resources/views/layouts/student_app.blade.php ENDPATH**/ ?>