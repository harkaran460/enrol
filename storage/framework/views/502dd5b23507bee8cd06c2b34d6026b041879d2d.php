        ...
        <div class="row mt-5" id="admission-requirements">
            <div class="col-md-8">
                <div class="main-features-about">
                                        ...
                                        <div class="card-body">
                                            <div class="accordion" id="this-program-requires">
                                                <div class="accordion-item">
                                                    ...
                                                    <hr>
                                                    <h3> <?php echo e($score->test_scores_number); ?></h3>
                                                    <div id="minimum-language-featuresone"
                                                        ...
                                                        <div class="accordion-body">
                                                            <ul>
                                                                <li>
                                                                    <h5><b> Reading</b></h5>
                                                                    <h1><b> <?php echo e($score->reading); ?></b></h1>
                                                                </li>
                                                                <li>
                                                                    <h5><b> Writing</b></h5>
                                                                    <h1><b> <?php echo e($score->writing); ?></b></h1>
                                                                </li>
                                                                <li>
                                                                    <h5><b> Listening</b></h5>
                                                                    <h1><b> <?php echo e($score->listening); ?></b></h1>
                                                                </li>
                                                                <li>
                                                                    <h5><b> Speaking</b></h5>
                                                                    <h1><b> <?php echo e($score->speaking); ?></b></h1>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                    ...
                    <?php endif; ?>
                    <?php if(isset($profile_updated->id)): ?>
                    <?php if($profile_updated->id ==''): ?>
                    <div class="bg-white p-3 mt-3">
...
<?php echo $__env->make('layouts.student_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/college/resources/views/student/student_programs_college.blade.php ENDPATH**/ ?>