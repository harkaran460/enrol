                        ...
                        <div class="main-programs-img">
                            ...
                            <div class="ps-3"> 
                                ...
                                <ul class="college-location-way"> 
                                    <li><img src="https://www.callcenterdialerprovider.com/applyhere/student-login/assets/img/flag1.svg" width="30" height="30" alt=""> <?php echo e($college_details[0]->college_country); ?></li>
                                    <li><img src="https://www.callcenterdialerprovider.com/applyhere/agent/assets/img/location.svg" width="30" height="30" alt=""> <?php echo e($college_details[0]->college_address); ?></li> 
                                </ul>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="program-card bg-white p-3"> 
                        <div class="program-card-main">
                            ...
                            <div class="program-card-heading">
                                <h4><a href="programs-college.php"> <?php echo e($course->programs_name); ?> </a></h4>
                                ...
                                <ul>
                                    ...
                                    <!--<li>
                                        <div class="list-li">
                                            <p>Commission</p>
                                            <p><?php echo e($course->programs_name); ?>£1,470.00 GBP</p>
                                        </div>
                                    </li>-->
                                </ul>
...
<?php echo $__env->make('layouts.student_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/design/resources/views/student/student_college_details.blade.php ENDPATH**/ ?>