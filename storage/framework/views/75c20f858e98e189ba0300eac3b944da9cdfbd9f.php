        ...
        <div class="container-fluid mt-4">
                        ...
                        <div class="css-1y75kwg css-1jlq0r60">
                            <div class="css-q6cz2y css-1jlq0r62">
                                <div class="css-1jlq0r65 css-gqqadv">
                                    ...
                                    <!--    <?php echo e(ucfirst(trans($firstcaracter))); ?> </div>-->
            ...
            <div class="row mt-md-3">
                <div class="col-md-12">
                    <div id="error"></div>
                    <div id="success"></div>
                    <?php if($studentdetails[0]->created_at !=''): ?>
                    ...
                    <form action="/agent-student-profile-update" method="POST" name="updatestudentProfile"
                        ...
                        <input type="hidden" name="id" id="id" value="<?php echo e($studentdetails[0]->rowid); ?>">
                        <div class="card p-2">
                            <div class="card-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="<?php echo e($studentdetails[0]->middle_name); ?>" name="middle_name"
                                                    id="middle_name">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="<?php echo e($studentdetails[0]->last_name); ?>" name="last_name"
                                                    id="last_name">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control datepicker_input"
                                                    value="<?php echo e($studentdetails[0]->date_of_birth); ?>"
                                                    placeholder="<?php echo e($studentdetails[0]->date_of_birth); ?>"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="<?php echo e($studentdetails[0]->first_language); ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="country_of_citizenship" id="country_of_citizenship"
                                                    ...
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($country->id); ?>" <?php echo e($studentdetails[0]->country_of_citizenship == "$country->id" ? 'selected' : ''); ?>>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control"
                                                    ...
                                                    value="<?php echo e($studentdetails[0]->passport_number); ?>"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Email..."
                                                    value="<?php echo e($studentdetails[0]->email); ?>" name="email"
                                                    id="email" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control"
                                                    placeholder="Enter Phone Number..."
                                                    value="<?php echo e($studentdetails[0]->phone_number); ?>" name="phone_number"
                                                    id="phone_number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control"
                                                    ...
                                                    value="<?php echo e($studentdetails[0]->postal_code); ?>" name="postal_code"
                                                    id="postal_code">
                                            </div>
                                        </div>
                                        <!--<div class="col-md-4">-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <label> Grade Average <span class="red">*</span> </label>
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="<?php echo e($studentdetails[0]->grade_average); ?>" name="grade_average"
                                                    id="grade_average">
                                            </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="row mt-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value=" <?php echo e($studentdetails[0]->name_of_institution); ?>"
                                        ...
                                        <div class="row mt-md-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($studentdetails[0]->primary_language_of_instruction); ?>"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control datepicker_input"
                                                    value="<?php echo e($studentdetails[0]->attended_institution_from); ?>"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control datepicker_input"
                                                    value="<?php echo e($studentdetails[0]->attended_institution_to); ?>"
                                        ...
                                        <div class="row mt-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control datepicker_input"
                                                        value="<?php echo e($studentdetails[0]->graduation_date); ?>"
                                        ...
                                        <div class="row mt-md-3">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Address<span class="red">*</span> </label>
                                                    <input type="text" class="form-control"
                                                        value="<?php echo e($studentdetails[0]->school_address); ?>"
                                        ...
                                        <div class="row mt-md-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="<?php echo e($studentdetails[0]->school_postal_code); ?>"
                                        ...
                                        <div>
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="country_of_institution2" id="country_of_institution2"
                                                            ...
                                                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($country->id); ?>"
                                                                    <?php echo e($studentdetails[0]->country_of_institution2 == $country->id ? 'selected' : ''); ?>>
                                                                    <?php echo e($country->country); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label> Name of Institution <span class="red"></span> </label>
                                                        <input type="text" class="form-control"
                                                            value=" <?php echo e($studentdetails[0]->name_of_institution2); ?>"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="level_of_education2" id="level_of_education2"
                                                            ...
                                                            <?php $__currentLoopData = $educationlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($list->id); ?>"
                                                                    <?php echo e($studentdetails[0]->level_of_education2 == "$list->id" ? 'selected' : ''); ?>>
                                                                    <?php echo e($list->title); ?>
                                            ...
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="<?php echo e($studentdetails[0]->primary_language_of_instruction2); ?>"
                                                ...
                                                <div class="col-md-4">
                                                    <label> Attended Institution From <span class="red"></span> </label>
                                                    <input type="text" class="form-control datepicker_input"
                                                        value="<?php echo e($studentdetails[0]->attended_institution_from2); ?>"
                                                ...
                                                <div class="col-md-4">
                                                    <label> Attended Institution To <span class="red"></span> </label>
                                                    <input type="text" class="form-control datepicker_input"
                                                        value="<?php echo e($studentdetails[0]->attended_institution_to2); ?>"
                                            ...
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Enter Degree Name..."
                                                            value="<?php echo e($studentdetails[0]->degree_name2); ?>" name="degree_name2"
                                                            id="degree_name2">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group radio-main">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                value="1"
                                                                <?php echo e($studentdetails[0]->graduated_institution2 == 1 ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="flexRadioDefault6">
                                                                Yes
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="graduated_institution2" id="graduated_institution2"
                                                                value="0"
                                                                <?php echo e($studentdetails[0]->graduated_institution2 == 0 ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="flexRadioDefault5">
                                                                No
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Graduation Date <span class="red"></span> </label>
                                                        <input type="text" class="form-control datepicker_input"
                                                            value="<?php echo e($studentdetails[0]->graduation_date2); ?>"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="1"
                                                            ...
                                                            <?php echo e($studentdetails[0]->physical_certificate_for_this_degree2 == '1' ? 'checked' : ''); ?>>
                                                        <label class="form-check-label" for="flexCheckDefaultphysical">
                                                            I have the physical certificate for this degree
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Address<span class="red"></span> </label>
                                                        <input type="text" class="form-control"
                                                            value="<?php echo e($studentdetails[0]->school_address2); ?>"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="school_province2" id="school_province2"
                                                            ...
                                                            <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($state->id); ?>"
                                                                    <?php echo e($studentdetails[0]->school_province2 == "$state->id" ? 'selected' : ''); ?>>
                                                                    <?php echo e($state->state); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="school_city_town2" id="school_city_town2"
                                                            ...
                                                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($city->id); ?>"
                                                                    <?php echo e($studentdetails[0]->school_city_town2 == "$city->id" ? 'selected' : ''); ?>>
                                                                    <?php echo e($city->city); ?>
                                            ...
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter Postal/Zip Code..."
                                                        value="<?php echo e($studentdetails[0]->school_postal_code2); ?>"
                                        ...
                                        <div>
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="country_of_institution3" id="country_of_institution3"
                                                            ...
                                                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($country->id); ?>"
                                                                    <?php echo e($studentdetails[0]->country_of_institution3 == $country->id ? 'selected' : ''); ?>>
                                                                    <?php echo e($country->country); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label> Name of Institution <span class="red"></span> </label>
                                                        <input type="text" class="form-control"
                                                            value=" <?php echo e($studentdetails[0]->name_of_institution3); ?>"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="level_of_education3" id="level_of_education3"
                                                            ...
                                                            <?php $__currentLoopData = $educationlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($list->id); ?>"
                                                                    <?php echo e($studentdetails[0]->level_of_education3 == "$list->id" ? 'selected' : ''); ?>>
                                                                    <?php echo e($list->title); ?>
                                            ...
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="<?php echo e($studentdetails[0]->primary_language_of_instruction3); ?>"
                                                ...
                                                <div class="col-md-4">
                                                    <label> Attended Institution From <span class="red"></span> </label>
                                                    <input type="text" class="form-control datepicker_input"
                                                        value="<?php echo e($studentdetails[0]->attended_institution_from3); ?>"
                                                ...
                                                <div class="col-md-4">
                                                    <label> Attended Institution To <span class="red"></span> </label>
                                                    <input type="text" class="form-control datepicker_input"
                                                        value="<?php echo e($studentdetails[0]->attended_institution_to3); ?>"
                                            ...
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Enter Degree Name..."
                                                            value="<?php echo e($studentdetails[0]->degree_name3); ?>" name="degree_name3"
                                                            id="degree_name3">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group radio-main">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                value="1"
                                                                <?php echo e($studentdetails[0]->graduated_institution3 == 1 ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="flexRadioDefault6">
                                                                Yes
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="graduated_institution3" id="graduated_institution3"
                                                                value="0"
                                                                <?php echo e($studentdetails[0]->graduated_institution3 == 0 ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="flexRadioDefault5">
                                                                No
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Graduation Date <span class="red"></span> </label>
                                                        <input type="text" class="form-control datepicker_input"
                                                            value="<?php echo e($studentdetails[0]->graduation_date3); ?>"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="1"
                                                            ...
                                                            <?php echo e($studentdetails[0]->physical_certificate_for_this_degree3 == '1' ? 'checked' : ''); ?>>
                                                        <label class="form-check-label" for="flexCheckDefaultphysical">
                                                            I have the physical certificate for this degree
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Address<span class="red"></span> </label>
                                                        <input type="text" class="form-control"
                                                            value="<?php echo e($studentdetails[0]->school_address3); ?>"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="school_province3" id="school_province3"
                                                            ...
                                                            <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($state->id); ?>"
                                                                    <?php echo e($studentdetails[0]->school_province3 == "$state->id" ? 'selected' : ''); ?>>
                                                                    <?php echo e($state->state); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="school_city_town3" id="school_city_town3"
                                                            ...
                                                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($city->id); ?>"
                                                                    <?php echo e($studentdetails[0]->school_city_town3 == "$city->id" ? 'selected' : ''); ?>>
                                                                    <?php echo e($city->city); ?>
                                            ...
                                            <div class="row mt-md-3">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter Postal/Zip Code..."
                                                        value="<?php echo e($studentdetails[0]->school_postal_code3); ?>"
 ...
 <div class="box-holder p-4 mt-2" >
  ...
  <div id="indianSchoolmain">
      <div id="indianSchoolmaininner" class="mx-4">
         ...
         <h2 class="text-start pt-2 fs-3"><?php echo e($studentdetails[0]->name_of_institution); ?></h2>
          ...
          <div id="ischoolmain-Three" class="d-flex justify-content-between flex-wrap">
               <div>
                                                ...
                                                <div class="inSchul-right-main">
                                                     <span>
                                                         <?php echo e($studentdetails[0]->degree_name); ?>
          ...
          <div id="ischoolmain-Four" class="d-flex justify-content-between flex-wrap">
               <div>
                                                ...
                                                <div class="inSchul-right-main">
                                                     <span >
                                                        <?php echo e(date('F d, Y', strtotime($studentdetails[0]->attended_institution_from))); ?> -  <?php echo e(date('F d, Y', strtotime($studentdetails[0]->attended_institution_to))); ?>
          ...
          <div id="ischoolmain-Five" class="d-flex justify-content-between flex-wrap">
               <div>
                                                ...
                                                <div class="inSchul-right-main">
                                                     <span >
                                                        <?php echo e($studentdetails[0]->primary_language_of_instruction); ?>
               ...
               <div>
                                                ...
                                                <div class="inSchul-right-main">
                                                     <span>
                                                        ...
                                                        <?php echo e($studentdetails[0]->school_address); ?> -
                                                    <?php echo e($studentdetails[0]->school_city_town); ?>,
                                                        <?php echo e($studentdetails[0]->school_province); ?>,
                                                    <?php echo e($studentdetails[0]->country_of_institution_name); ?>
...
<!--INDIAN SCHOOL LEARNING SECTION BY KD-->
                                    ...
                                    <!--    </div>-->
                                    <!--    <div class="col-md-4">-->
                                    <!--        <?php if($studentdetails[0]->graduation_date != ''): ?>-->
                                    <!--            <div>-->
                                    <!--                <svg role="img" width="24" height="24" fill="none"-->
                                    <!--                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">-->
                                    <!--                    <path fill-rule="evenodd" clip-rule="evenodd"-->
                                    ...
                                    <!--            </div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->degree_name != ''): ?>-->
                                    <!--            <div>-->
                                    <!--                <svg role="img" width="24" height="24" fill="none"-->
                                    <!--                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">-->
                                    <!--                    <path fill-rule="evenodd" clip-rule="evenodd"-->
                                    ...
                                    <!--            <div><strong>Level:</strong> <?php echo e($studentdetails[0]->degree_name); ?></div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->attended_institution_from != ''): ?>-->
                                    ...
                                    <!--<div class="row mt-md-3">-->
                                    <!--    <div class="col-md-4">-->
                                    <!--        <p><?php echo e($studentdetails[0]->name_of_institution2); ?> </p>-->
                                    <!--    </div>-->
                                    <!--    <div class="col-md-4">-->
                                    <!--        <?php if($studentdetails[0]->graduation_date2 != ''): ?>-->
                                    <!--            <div>-->
                                    <!--                <svg role="img" width="24" height="24" fill="none"-->
                                    <!--                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">-->
                                    <!--                    <path fill-rule="evenodd" clip-rule="evenodd"-->
                                    ...
                                    <!--                </svg>-->
                                    <!--                <strong> Graduated from Institution </strong><span>-->
                                    <!--                    <?php echo e(date('F d, Y', strtotime($studentdetails[0]->graduation_date2))); ?>-->
                                    <!--                </span>-->
                                    <!--            </div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->degree_name2 != ''): ?>-->
                                    <!--            <div>-->
                                    <!--                <svg role="img" width="24" height="24" fill="none"-->
                                    <!--                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">-->
                                    <!--                    <path fill-rule="evenodd" clip-rule="evenodd"-->
                                    ...
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->degree_name2 != ''): ?>-->
                                    <!--            <div><strong>Level:</strong> <?php echo e($studentdetails[0]->degree_name2); ?></div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->attended_institution_from2 != ''): ?>-->
                                    <!--            <div><strong>Attended from </strong><span>-->
                                    <!--                    <?php echo e(date('F d, Y', strtotime($studentdetails[0]->attended_institution_from2))); ?>-->
                                    <!--                </span><strong> to </strong><span>-->
                                    <!--                    <?php echo e(date('F d, Y', strtotime($studentdetails[0]->attended_institution_to2))); ?>-->
                                    <!--                </span></div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->primary_language_of_instruction2 != ''): ?>-->
                                    <!--            <div><strong>Language of instruction:-->
                                    <!--                </strong><span><?php echo e($studentdetails[0]->primary_language_of_instruction2); ?></span>-->
                                    <!--            </div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->school_address2 != ''): ?>-->
                                    <!--            <div class="address">-->
                                    <!--                <div><strong>Address:</strong> <?php echo e($studentdetails[0]->school_address2); ?></div>-->
                                                    
                                    <!--                <div><?php echo e($studentdetails[0]->school_city_town2); ?>,-->
                                    <!--                    <?php echo e($studentdetails[0]->school_province2); ?></div>-->
                                    <!--                <div><?php echo e($studentdetails[0]->country_of_institution_name2); ?></div>-->
                                    <!--            </div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--    </div>-->
                                    <!--    <div class="col-md-4"></div>-->
                                    ...
                                    <!--<div class="row mt-md-3">-->
                                    <!--    <div class="col-md-4">-->
                                    <!--        <p><?php echo e($studentdetails[0]->name_of_institution3); ?></p>-->
                                    <!--    </div>-->
                                    <!--    <div class="col-md-4">-->
                                    <!--        <?php if($studentdetails[0]->graduation_date3 != ''): ?>-->
                                    <!--            <div>-->
                                    <!--                <svg role="img" width="24" height="24" fill="none"-->
                                    <!--                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">-->
                                    <!--                    <path fill-rule="evenodd" clip-rule="evenodd"-->
                                    ...
                                    <!--                </svg>-->
                                    <!--                <strong> Graduated from Institution </strong><span>-->
                                    <!--                    <?php echo e(date('F d, Y', strtotime($studentdetails[0]->graduation_date3))); ?>-->
                                    <!--                </span>-->
                                    <!--            </div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->degree_name3 != ''): ?>-->
                                    <!--            <div>-->
                                    <!--                <svg role="img" width="24" height="24" fill="none"-->
                                    <!--                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">-->
                                    <!--                    <path fill-rule="evenodd" clip-rule="evenodd"-->
                                    ...
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->degree_name3 != ''): ?>-->
                                    <!--            <div><strong>Level:</strong> <?php echo e($studentdetails[0]->degree_name3); ?></div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->attended_institution_from3 != ''): ?>-->
                                    <!--            <div><strong>Attended from </strong><span>-->
                                    <!--                    <?php echo e(date('F d, Y', strtotime($studentdetails[0]->attended_institution_from3))); ?>-->
                                    <!--                </span><strong> to </strong><span>-->
                                    <!--                    <?php echo e(date('F d, Y', strtotime($studentdetails[0]->attended_institution_to3))); ?>-->
                                    <!--                </span></div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->primary_language_of_instruction3 != ''): ?>-->
                                    <!--            <div><strong>Language of instruction:-->
                                    <!--                </strong><span><?php echo e($studentdetails[0]->primary_language_of_instruction3); ?></span>-->
                                    <!--            </div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--        <?php if($studentdetails[0]->school_address3 != ''): ?>-->
                                    <!--            <div class="address">-->
                                    <!--                <div><strong>Address:</strong>   <?php echo e($studentdetails[0]->school_address3); ?></div>-->
                                                    
                                    <!--                <div><?php echo e($studentdetails[0]->school_city_town3); ?>,-->
                                    <!--                    <?php echo e($studentdetails[0]->school_province3); ?></div>-->
                                    <!--                <div><?php echo e($studentdetails[0]->country_of_institution_name3); ?></div>-->
                                    <!--            </div>-->
                                    <!--        <?php endif; ?>-->
                                    <!--    </div>-->
                                    <!--    <div class="col-md-4"></div>-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control"
                                                    value="<?php echo e($studentdetails[0]->gre_exam_date); ?>" name="gre_exam_date"
                                                    id="gre_exam_date">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->gre_verbal_score); ?>"
                                                    name="gre_verbal_score" id="gre_verbal_score">
                                                <input type="tel" class="form-control mt-1" placeholder="Rank %"
                                                    value="<?php echo e($studentdetails[0]->gre_verbal_rank); ?>"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->gre_quantitative_score); ?>"
                                                    name="gre_quantitative_score" id="gre_quantitative_score">
                                                <input type="tel" class="form-control mt-1" placeholder="Rank %"
                                                    value="<?php echo e($studentdetails[0]->gre_quantitative_rank); ?>"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label> Writing </label>
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->gre_writing_score); ?>"
                                                    name="gre_writing_score" id="gre_writing_score">
                                                <input type="tel" class="form-control mt-1" placeholder="Rank %"
                                                    value="<?php echo e($studentdetails[0]->gre_writing_rank); ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control"
                                                    value="<?php echo e($studentdetails[0]->gmat_gre_exam_date); ?>"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label> Verbal </label>
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->gmat_verbal_score); ?>"
                                                    name="gmat_verbal_score" id="gmat_verbal_score">
                                                <input type="tel" class="form-control mt-1" placeholder="Rank %"
                                                    value="<?php echo e($studentdetails[0]->gmat_verbal_rank); ?>"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label> Quantitative </label>
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->gmat_quantitative_score); ?>"
                                                    name="gmat_quantitative_score" id="gmat_quantitative_score">
                                                <input type="tel" class="form-control mt-1" placeholder="Rank %"
                                                    value="<?php echo e($studentdetails[0]->gmat_quantitative_rank); ?>"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label> Writing </label>
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->gmat_writing_score); ?>"
                                                    name="gmat_writing_score" id="gmat_writing_score">
                                                <input type="tel" class="form-control mt-1" placeholder="Rank %"
                                                    value="<?php echo e($studentdetails[0]->gmat_writing_rank); ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control"
                                                    value="<?php echo e($studentdetails[0]->date_of_exam); ?>" name="date_of_exam"
                                                    id="date_of_exam">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->lisenting); ?>" name="lisenting"
                                                    id="lisenting">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label> Reading </label>
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->reading); ?>" name="reading"
                                                    id="reading">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label> Writing </label>
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->writing); ?>" name="writing"
                                                    id="writing">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" placeholder="Score"
                                                    value="<?php echo e($studentdetails[0]->speaking); ?>" name="speaking"
                                                    id="speaking">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="exam_type" id="exam_type">
                                                    <?php $__currentLoopData = $getEnglishexamType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value=<?php echo e($type->id); ?> <?php if($studentdetails[0]->english_exam_type == $type->id ){ echo "selected";}else{echo "";}?>><?php echo e($type->exam_name); ?>
                                ...
                                <div class="row mt-md-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="more_background_details" id="more_background_details" cols="10" rows="4"
                                            class="form-control" placeholder="Provide details..."><?php echo e($studentdetails[0]->more_background_details); ?></textarea>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.agent_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/design/resources/views/agent/student_profile.blade.php ENDPATH**/ ?>