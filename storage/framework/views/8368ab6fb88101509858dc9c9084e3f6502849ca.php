                                    ...
                                    <form action="collagefilter" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control select2-multiple " id="country" name ="collage_country[]" multiple="multiple" data-placeholder="select ...">
                                                <option value="">-- select one --</option>
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option data-id="<?php echo e($country->id); ?>" value="<?php echo e($country->country); ?>"><?php echo e($country->country); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" multiple="multiple" name="collage_name[]" data-placeholder="select ...">
                                                ...
                                                <option value="<?php echo e($college->college_name); ?>"><?php echo e($college->college_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="form-group mt-3">
                                    ...
                                    <form action="programfilter" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control select2-multiple" multiple="multiple" name="inakes_date[]" data-placeholder="select ...">
                                               ...
                                               <option value="<?php echo e($date->earliest_intake_date); ?>"><?php echo e(date('d-F-Y', strtotime($date->earliest_intake_date))); ?></option>   
                                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                               <?php endif; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control select2-multiple" name="post_discipline[]" multiple="multiple" data-placeholder="select ...">
                                                ...
                                                <option value="<?php echo e($disc->id); ?>"><?php echo e($disc->title); ?></option>   
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control select2-multiple" name="sub_categories[]" multiple="multiple" data-placeholder="select ...">
                                                ...
                                                <option value="<?php echo e($sub_cat->id); ?>"><?php echo e($sub_cat->sub_cat_name); ?></option>   
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                        </div>
                ...
                <div class="program-list">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            ...
                            <button class="nav-link active" id="programs-tab" data-bs-toggle="pill" data-bs-target="#programs" type="button" role="tab" aria-controls="programs" aria-selected="false">Programs ( <?php if($collages !='not_found'): ?> <?php echo e($courseTotal); ?><?php else: ?> 0 <?php endif; ?>) </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="school-tab" data-bs-toggle="pill" data-bs-target="#school" type="button" role="tab" aria-controls="school" aria-selected="true">Collages ( <?php if($collages !='not_found'): ?> <?php echo e(count($collages)); ?><?php else: ?> 0 <?php endif; ?>) </button>
                        </li>
                    </ul>
                         ...
                         <?php if($collages !='not_found'): ?>
                            ...
                            <div class="main-programs-content">
                                <div class="main-programs-img">
                                    <a href="/college-details/<?php echo e($list->id); ?>")>
                                        <img width="48" height="48" src="<?php echo e(url('/images/'.$list->college_logo)); ?>" alt="Logo"/>
                                    </a>
                                    <div>
                                        <div>
                                            <a href="/college-details/<?php echo e($list->id); ?>" class="css-6g7jag"><?php echo e($list->college_name); ?></a>
                                           <!-- <a target="_blank" href="college-details.php"><?php echo e($list->college_name); ?></a>-->
                                        </div>
                                ...
                                <div class="main-programs-img-content">
                                    <div class="">
                                        <div>
                                            <a href="<?php echo e(URL::to('programs-college')); ?>/<?php echo e($p->id); ?>" class="font-size-24 text-capitalize"><?php echo e($p->programs_name); ?></a>
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <form action="/application" method="post">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="program_id" id="program_id" value="<?php echo e($p->id); ?>">
                                ...
                                <div class="text-center">
                                    <a href="javascript:;" class="see-more"> See <?php echo e(count($list->courses)); ?> More Programs <i class="fa fa-chevron-down"></i></a>
                                    <hr />
                                    <div class="main-slide">
                                        ...
                                        <div class="main-programs-img-content">
                                            <div class="text-start">
                                                <div>
                                                    <a href="<?php echo e(URL::to('programs-college')); ?>/<?php echo e($plist->id); ?>" class="font-size-24 text-capitalize"><?php echo e($plist->programs_name); ?></a>
                                                </div>
                                                <div class="main-programs-list">
                                                    <div class="css-1kos2q0">
                                                        <span>TUITION FEE</span>
                                                ...
                                                <div class="col-md-12 mt-2" style="text-align: start;">
                                                    <form action="/application" method="post">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="hidden" name="program_id" id="program_id" value="<?php echo e($plist->id); ?>">
                                                        <button type="submit" style="color:white;" class="btn btn-primary">Start Application</button>
                                                    </form>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="school-tabs-section">
                                        <div class="school-tabs-content">
                                            <img width="68" height="68" src="<?php echo e(url('/images/'.$collage->college_logo)); ?>" alt="Logo"/>
                                            <div class="school-tabs-main">
                                               
                                                <a href="<?php echo e(URL::to('college-details')); ?>/<?php echo e($collage->id); ?>"><?php echo e($collage->college_name); ?></a>
                                                <h4>  <?php echo e($collage->college_address); ?>, <?php echo e($collage->college_country); ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.student_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/college/resources/views/student/program.blade.php ENDPATH**/ ?>