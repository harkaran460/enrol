                                                ...
                                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                                    <div class="accordion-body text-center">
                                                        ...
                                                        <div class="pt-4">
                                                            ...
                                                            <a href="#" class="text-primary">https://www.applyboard.com/discover/gic?Opportunity.RP_ID__c=214027#gic_form_link</a>

                                                            <ul class="nav nav-pills mb-3 pt-5 d-flex justify-content-center" id="pills-tab" role="tablist">
                                                                <li class="nav-item" role="presentation">
                                                                    <button class="nav-link me-3" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Show QR Code</button>
                                                                </li>
                                                            ...
                                                            <div class="tab-content pt-4" id="pills-tabContent">
                                                                <div class="tab-pane fade show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"><img src="assetsAgent/img/qr-code%20(1).png" alt="" width="250"><br>
                                                ...
                                                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                                    <div class="accordion-body">
                                                        <div class="text-center">
                                                            ...
                                                            <button type="button" class="btn btn-primary my-4">Learn More</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.agent_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/college/resources/views/agent/growth_hub.blade.php ENDPATH**/ ?>