...
<?php $application_status = getCurrentStatus() ?>
<?php $payment_status = getPaymentStatus() ?>
        ...
        <div class="container-fluid pt-5">
                                ...
                                <table class="table">
                                                ...
                                                <td scope="col">
                                                    <div class="input-control">
                                                        <select class="form-select" name="payment_status" aria-label="Default select example" onchange="this.form.submit()" style="width: 170px;">
                                                            ...
                                                            <option value="<?php echo e($ps->id); ?>"><?php echo e($ps->status_name); ?></option>   
                                                ...
                                                <td scope="col">
                                                    <div class="input-control">
                                                        <select class="form-select" name="application_status" aria-label="Default select example" onchange="this.form.submit()" style="width: 170px;">
                                                            ...
                                                            <?php $__currentLoopData = $application_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $as): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($as->id); ?>"><?php echo e($as->status_title); ?></option>   
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php endif; ?>
                                                        </select>
                                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td> 
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        <li><a class="dropdown-item" href="/admin-application-review/<?php echo e($applicationlist->app_id); ?>"><i class="bi bi-pencil"></i> View Application</a></li>
                                                    </ul>
                                                </div> 
                                            </td>
                                            <td class="text-center"><a href="#"><?php echo e(date('d-M-Y', strtotime($applicationlist->payment_date))); ?> </a></td>
                                            <td class="text-center">
                                                <a href="/admin-application-review/<?php echo e($applicationlist->app_id); ?>"><?php echo e($applicationlist->app_id); ?></a>
                                            </td>
                                            <td class="text-center"><?php echo e($applicationlist->user_id); ?></td>
                                            <td class="text-center"><span><?php echo e($applicationlist->email); ?></span></td>
                                            ...
                                            <td><span><?php echo e(date('d-M-Y', strtotime($applicationlist->earliest_intake_date))); ?> </span></td>
                                            <td class="text-center"><a href="#"><?php echo e($applicationlist->partner_email); ?></a></td> 

                                            
                                            <td class="text-center"><span class="<?php echo e($applicationlist->bgcolor); ?> px-2 py-1 rounded-pill text-white text-white"><?php echo e($applicationlist->status_name); ?></span></td>
                                            ...
                                            <td class="text-center">
                                                <span class="bg-light px-3 py-1 rounded-pill"><?php echo e($applicationlist->status_title); ?></span>
                                            </td>
                                            
                                            <td class="text-center">
                                            <span class="application_view"><a href="/admin-application-review/<?php echo e($applicationlist->app_id); ?>">View</a></span>
                                            </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
            ...
            <div class="row">
                ...
                <div class="col d-flex justify-content-start align-items-center py-3">
                   ...
                   <div class="cpagination">     <?php echo e($application_list->links()); ?> </div>
...
<?php echo $__env->make('layouts.admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/design/resources/views/admin/admin-application.blade.php ENDPATH**/ ?>