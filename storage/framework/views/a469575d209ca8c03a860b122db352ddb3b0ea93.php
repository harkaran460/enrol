						...
						<div class="row">
							<div class="col-md-6">
								<div class="myapplication-block">
									...
									<div class="col-md-12" id="fileupload1">
										<form id="fileupload" action="<?php echo e(route('studentEducationDocuments.store')); ?>" method="post" enctype="multipart/form-data">
								...
								<div class="myapplication-block">
									...
									<div class="col-md-12">
										<form id="fileupload_1" action="<?php echo e(route('workExperienceDocuments.store')); ?>" method="post" enctype="multipart/form-data">
											<!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->
											<div class="row fileupload-buttonbar">
												<div class="col-lg-12">
													<!-- The fileinput-button span is used to style the file input field as button -->
								...
								<div class="myapplication-block">
									...
									<div class="col-md-12">
										<form id="fileupload_2" action="<?php echo e(route('emergencyContactDocuments.store')); ?>" method="post" enctype="multipart/form-data">
											<!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->
											<div class="row fileupload-buttonbar">
												<div class="col-lg-12">
													<!-- The fileinput-button span is used to style the file input field as button -->
							...
							<div class="col-md-6">
								<div class="myapplication-block">
									...
									<div class="col-md-12">
										<form id="fileupload_3" action="<?php echo e(route('englishTestScoreDocuments.store')); ?>" method="post" enctype="multipart/form-data">
											<!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->
											<div class="row fileupload-buttonbar">
												<div class="col-lg-12">
													<!-- The fileinput-button span is used to style the file input field as button -->
								...
								<div class="myapplication-block">
									...
									<div class="col-md-12">
										<form id="fileupload_4" action="<?php echo e(route('passportAndTravelHistoryDocuments.store')); ?>" method="post" enctype="multipart/form-data">
											<!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->
											<div class="row fileupload-buttonbar">
												<div class="col-lg-12">
													<!-- The fileinput-button span is used to style the file input field as button -->
...
<?php echo $__env->make('_partials.x-template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('js/upload_app.js')); ?>"></script>
<script src="<?php echo e(asset('js/emergency_contact_app.js')); ?>"></script>
<script src="<?php echo e(asset('js/english_test_score_app.js')); ?>"></script>
<script src="<?php echo e(asset('js/passport_and_travel_history_app.js')); ?>"></script>
<script src="<?php echo e(asset('js/work_experience_app.js')); ?>"></script>
...
<script>
	function getMyProfile() {
		...
		$.ajax({
			url: "<?php echo e(route('getMyProfile')); ?>",
			type: "POST",
	...
	if ($("#updateMyProfile").length > 0) {
		$("#updateMyProfile").validate({
			...
			submitHandler: function(form) {
				...
				$.ajax({
					url: "<?php echo e(route('updateMyProfile')); ?>",
					type: "POST",
					data: formData,
					processData: false,
					contentType: false,
	...
	if ($("#profileUpdate").length > 0) {
		$("#profileUpdate").validate({
			...
			submitHandler: function(form) {
				...
				$.ajax({
					url: "<?php echo e(route('updateProfilePicture')); ?>",
					type: "POST",
					data: formData,
					processData: false,
					contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.student_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/college/resources/views/student/my_profile.blade.php ENDPATH**/ ?>