            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="review-main bg-white p-3">
                        ...
                        <ul>
                            <li><a href="/agentDashboard"> Home</a></li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li><a href="/sub_agent"> Recruitment Partners</a></li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li><a href="#recruitment-partner-id.php"> EnrolHere</a></li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li><a href="/students/"> Students</a></li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li><a href="/agent-student-profile/<?php echo e($student_details->id); ?>"> <?php echo e($student_details->first_name); ?> <?php echo e($student_details->middle_name); ?> <?php echo e($student_details->last_name); ?> </a></li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li><a href="/student-profile-application/<?php echo e($student_details->id); ?>"><b> Applications</b></a> [<?php echo e($student_details->app_id); ?>]</li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li> <a href="/agent-program-details/<?php echo e($student_details->progoramid); ?>"><?php echo e($student_details->programs_name); ?></a> @ <a href="/agent-college-details/<?php echo e($student_details->college_id); ?>"><?php echo e($student_details->program_college_name); ?> - <?php echo e($student_details->college_address); ?></a></li>
                        </ul>
                        <hr>
                    </div>
                </div>
                            ...
                            <div class="css-11bq05t">
                                <div class="css-xdzpz9">
                                    ...
                                    <div class="css-1dt3oac">
                                        <a href="/agent-college-details/<?php echo e($student_details->college_id); ?>"><?php echo e($student_details->program_college_name); ?> - <?php echo e($student_details->college_address); ?></a>
                                    </div>
                                </div>
                                <div class="css-15zjdt5">
                                    <a href="/agent-program-details/<?php echo e($student_details->progoramid); ?>"><?php echo e($student_details->programs_name); ?></a>
                                </div>
                                    ...
                                    <h2 class="accordion-header" id="student-profile-headingOne">
                                        <div class="row">
                                            <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#student-profile-collapseOne" aria-expanded="true">
                                                ...
                                                <div class="col-md-8">
                                                    <p class="fs-5"><?php echo e($student_details->id); ?> <a href="">| <?php echo e($student_details->first_name); ?> <?php echo e($student_details->middle_name); ?> <?php echo e($student_details->last_name); ?></a> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </h2>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8"> 
                                                    <ul>
                                                        ...
                                                        <li><?php echo e($student_details->email); ?></li>
                                                        <li> <br/><?php echo e($student_details->date_of_birth); ?>May 09, 1999 (23 years old)</li>
                                                        <li><?php echo e($student_details->phone_number); ?>+91-999-9999-999</li>
                                                        <li><?php echo e($student_details->first_language); ?>Punjabi</li>
                                                        <li><?php echo e($student_details->gender); ?>Male</li>
                                                        <li><?php echo e($student_details->marital_status); ?>Single</li>
                                                        <li><?php echo e($student_details->passport_number); ?>V3461463</li>
                                                        <li>NA</li>
                                                    </ul>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.agent_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/college/resources/views/agent/student_application_review.blade.php ENDPATH**/ ?>