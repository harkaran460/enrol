                    ...
                    <div class="main-programs-content"> 
                        <div class="main-programs-img form-control-lg">
                            ...
                            <div class="ps-3 align-self-md-end"> 
                                <h2 class="mb-0"><b> <?php echo e($college_details[0]->college_name); ?></b></h2> 
                                <ul class="college-location-way"> 
                                
                                    <li class="d-flex align-items-center mb-0 p-1">
                                        <img class="align-self-center" src="<?php echo e(asset('assetsAgent/img/flag1.svg')); ?>" alt="Generic placeholder image" width="30">
                                        <div class="flex-1">
                                          <h6 class="mb-0 fw-bold text-dark"><?php echo e($college_details[0]->college_country); ?></h6>
                                        </div>
                                    </li>
                                    ...
                                    <li class="d-flex align-items-center mb-0 p-1">
                                        <img class="align-self-center" src="<?php echo e(asset('assetsAgent/img/location.svg')); ?>" width="30" height="30" alt="">
                                        <div class="flex-1">
                                          <h6 class="mb-0 fw-bold text-dark"><?php echo e($college_details[0]->college_address); ?></h6>
                                        </div>
                                    </li> 
                                </ul>
                            </div>
                        ...
                        <!--</div>-->
                                    ...
                                    <div class="card-body bg-white" style="border-radius:10px">
                                        ...
                                        <div class="progress-w-percent">
                                            <span class="progress-value fw-bold"><?php echo e($college_details[0]->other); ?>% </span>
                                            <div class="progress progress-sm">
                                                <div class="progress-bar" role="progressbar" style="width: <?php echo e($college_details[0]->other); ?>%;" aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="progress-w-percent">
                                            <span class="progress-value fw-bold"><?php echo e($college_details[0]->other); ?>% </span>
                                            <div class="progress progress-sm">
                                                <div class="progress-bar" role="progressbar" style="width: <?php echo e($college_details[0]->other); ?>%;" aria-valuenow="39" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="progress-w-percent mb-2">
                                            <span class="progress-value fw-bold"><?php echo e($college_details[0]->other); ?>% </span>
                                            <div class="progress progress-sm">
                                                <div class="progress-bar" role="progressbar" style="width: <?php echo e($college_details[0]->other); ?>%;" aria-valuenow="61" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                    </div> 
...
<?php echo $__env->make('layouts.agent_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/design/resources/views/agent/college_details.blade.php ENDPATH**/ ?>