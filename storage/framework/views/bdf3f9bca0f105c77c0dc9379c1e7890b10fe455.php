                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="college_name" id="college_name" type="text"
                                                            ...
                                                            <span class="text-danger" style="font-size: 15px;"><?php echo e($errors->first('college_name')); ?></span>
                                                            <?php endif; ?>
                                                    </div>
                                                </div>
                                                <div class="col">
...
<?php /**PATH /home/enrolhere/public_html/college/resources/views/register/college_register.blade.php ENDPATH**/ ?>