...
<div class="page-content main-index">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="program_college_name" name="program_college_name" class="form-control" value="<?php echo e($colleges_name->college_name); ?>" disabled>
                                <input type="hidden" id="collegeid" name="collegeid" class="form-control" value="<?php echo e($colleges_name->id); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="select2 form-control select2-multiple" multiple="multiple" name="post_secondary_discipline" id="post_secondary_discipline" data-placeholder="select ...">
                                    <?php $__currentLoopData = $post_secondary_discipline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="select2 form-control select2-multiple" multiple="multiple" name="post_secondary_sub_categories" id="post_secondary_sub_categories" data-placeholder="select ...">
                                    <?php $__currentLoopData = $post_secondary_sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($data->id); ?>"><?php echo e($data->sub_cat_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <?php if(!empty($documents_requirment)): ?>
            <?php $__currentLoopData = $documents_requirment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $documentsrequirment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">  
                        <div class="form-group">  
                            <div class="col">
                                <input class="form-check-input" name="certificate_<?php echo e($documentsrequirment->id); ?>[]" type="checkbox" value="<?php echo e($documentsrequirment->id); ?>" id="certificate_<?php echo e($documentsrequirment->id); ?>">
                                <label class="form-check-label" for="certificate">
                                   <?php echo e($documentsrequirment->document_name); ?> 
                                </label>
                            </div>
                        </div> 
                    </div>
    ...
    if ($("#addProgramForm").length > 0) {
        $("#addProgramForm").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo e(route('addProgramSubmit.post')); ?>",
...
<?php echo $__env->make('layouts.college_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/design/resources/views/college/add_programs.blade.php ENDPATH**/ ?>