            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="add-training.php"><button type="button" class="btn btn-primary py-1">Add Training</button></a>
                    </div>
                    <div class="py-3">
...
<?php echo $__env->make('layouts.agent_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/college/resources/views/agent/training_request.blade.php ENDPATH**/ ?>