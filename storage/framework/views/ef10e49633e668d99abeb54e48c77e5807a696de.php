                    ...
                    <div class="row bg-white p-4">
                        <div class="col-md-5 ">
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php $count = 1; ?>
                                <?php $__currentLoopData = $payment_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($count); ?></td>
                                    <td><?php echo e($pd->payment_id); ?></td>
                                    <td><?php echo e($pd->created_at); ?></td>
                                    <td>NA</td>
                                    <td><?php echo e($pd->appid); ?></td>
                                    <td><?php echo e($pd->amount); ?></td>
                                    <td>Online</td>
                                    <td><?php echo e($pd->payment_amount); ?></td>
                                    <td><?php echo e($pd->app_status); ?></td>
                                    <td><?php echo e($pd->payment_status); ?></td>
                                    <td><?php echo e($pd->other); ?></td>
                                </tr>
                                <?php $count++  ?> 
                            ...
                            <div class="form-group mt-md-4"> 
                                <div class="d-grid gap-2">
                                   <?php echo e($payment_details->links()); ?>
...
<?php echo $__env->make('layouts.agent_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/design/resources/views/agent/student_payment.blade.php ENDPATH**/ ?>