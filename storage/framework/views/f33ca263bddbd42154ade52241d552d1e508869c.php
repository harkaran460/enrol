        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-md-5 shadow login text-center py-5 px-0">
                    ...
                    <form action="" method="POST" action="<?php echo e(route('login')); ?>" class="px-5 py-3">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="px-5">
                        ...
                        <div class="d-flex justify-content-between">
                            <span class="fs-5"><a href="<?php echo e('password/reset'); ?>" class="">Forgot password?</a></span>
...
</html><?php /**PATH /home/enrolhere/public_html/college/resources/views/auth/login.blade.php ENDPATH**/ ?>