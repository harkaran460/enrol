...
<?php $countries = getCountry();?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form id="fileupload" class="hello" action="<?php echo e(route('collegePictures.store')); ?>"
    ...
    <script>
        ...
        function getCollegeData() {
            $.ajax({
                url: "<?php echo e(route('getCollegeDetails')); ?>",
                type: "GET",
    ...
    if ($("#addCollegeForm").length > 0) {
        $("#addCollegeForm").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo e(route('addCollegeSubmit.post')); ?>",
...
<?php echo $__env->make('layouts.college_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enrolhere/public_html/college/resources/views/college/add_college.blade.php ENDPATH**/ ?>